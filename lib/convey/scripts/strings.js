...
(function () {
    ...
    WinJS.Namespace.define("Application", {
         ...
         * @param {string} text - Message box text
         * @param {function} handler - Handler function(boolean) to be called.
         * @param {Object} anchor - HTML element as anchor fpr placement of Message Box.
         * @param {string} className - Message box additional CSS class name
         ...
         * @param {string} primaryCommandText - Primary command button text
         * @param {string} secondaryCommandText - Secondary command button text
         * @param {function} handler - Handler function(boolean) to be called.
         * @param {string} className - Message box additional CSS class name
         * @returns {Object}  The fulfillment of an asynchronous select operation returned in a {@link https://msdn.microsoft.com/en-us/library/windows/apps/br211867.aspx WinJS.Promise} object..
         * @description Implements the alert box functionality. The handler function is called with true value by Ok and false by the Cancel button of the message box.
 ...
 * @param {string} text - Message box text
 * @param {string} primaryCommandText - Message box primary command button text
 * @param {string} secondaryCommandText - Message box secondary command button text
 * @param {function} handler - Handler function(boolean) to be called.
 * @param {string} className - Message box additional CSS class name
 * @global
 * @returns {Object}  The fulfillment of an asynchronous select operation returned in a {@link https://msdn.microsoft.com/en-us/library/windows/apps/br211867.aspx WinJS.Promise} object..
