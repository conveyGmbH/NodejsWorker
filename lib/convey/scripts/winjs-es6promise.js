    ...
    WinJS.Utilities._require([
        ...
        _Global.toES6Promise = function (winjsPromise) {
            ...
            if (!winjsPromise || !(typeof winjsPromise.then === "function")) {
                Log.print(Log.l.trace, "wrap non-promise value into native Promise object!");
                promise = _Global.Promise.resolve(winjsPromise);
            } else if (typeof winjsPromise.finally === "function") {
                Log.print(Log.l.trace, "is already a ES6 Promise object!");
                promise = winjsPromise;
            } else {
                var resolve = nop;
                var reject = nop;
                promise = new _Global.Promise(function (c, e) {
        ...
        _Global.toWinJSPromise = function (es6Promise) {
            ...
            if (!es6Promise || !(typeof es6Promise.then === "function")) {
                Log.print(Log.l.trace, "wrap non-promise value into WinJS Promise object!");
                ret = WinJS.Promise.wrap(es6Promise);
            } else if (typeof es6Promise.done === "function") {
                Log.print(Log.l.trace, "is already a WinJS Promise object!");
                ret = es6Promise;
            } else {
